...
/**
   ...
   /** 
    useEffect(async function () {
        ...
        setPost(await WateringHoles.getPost(parseInt(slug[0]), parseInt(slug[1])));
        ...
        async function loadComments() {
            ...
            let temp = [];
            for(let i = 1; i <= numberOfCommentsInPost; i++ ) {
                temp.push(await WateringHoles.getComment(1, i));
            }
        ...
        setLoading(false);
    }, [user, post, router.query.slug, setUser, setUserLink, setLoading, setPostGals, setComments])
    */