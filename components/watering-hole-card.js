...
const WateringHoleCard = ({ hole }) => {
    ...
    const holeLink = `/watering-holes/${parseInt(hole[0].hex, 16)}/`;
            ...
            <div className='flex flex-col z-20'>
                ...
                <div className='flex flex-row justify-between mt-2'>
                    <div className='rounded mr-2 my-2'>
                        <p className='-mt-2 text-blue-50'>{parseInt(hole[4].hex, 16)}</p>
                    </div>
                    
                    <div className='ml-2 my-2'>
                        <p className='-mt-2 text-blue-50'>{parseInt(hole[5].hex, 16)}</p>
                    </div>
                </div>
            </div>
        </div>
